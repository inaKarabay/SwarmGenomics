...
bwa mem -t 18 $working_dir/$3/bwa_index/index $working_dir$3/1trim.fastq.gz SRR11430608.1_2.trim.fastq.gz  | samtools sort -@ 18 -o $working_dir$3/bwa.sorted.bam
...
#IGV online igv.org/app/
#load fasta (fna) and indev (fai) for genome and vcf as track
